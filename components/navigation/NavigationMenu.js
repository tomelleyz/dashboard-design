    ...
    <>
      ...
      <div className="space-y-3.5">
        ...
        <motion.button
          ...
          onClick={() =>
            setIsNavigationPanelExpanded(!isNavigationPanelExpanded)
          }
          aria-label={isNavigationPanelExpanded ? "Hide panel" : "Expand panel"}
          title={isNavigationPanelExpanded ? "" : "Expand panel"}
          className="flex items-center gap-x-2 rounded-lg border border-solid border-black-500 px-4 py-3 text-xs font-semibold text-black-500"
        >
          <motion.svg
            width="16"
            height="16"
            ...
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true"
            animate={{ rotate: isNavigationPanelExpanded ? 0 : -180 }}
